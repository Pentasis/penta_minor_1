    ...
    guiHandleEvent = function(id, name, param)
      if name == "idAdded" and id:match("temp.view.entity_%d") then
        ...
        if not ent then
          ...
          if api.engine.getComponent(ent, 70) or
           api.engine.getComponent(ent, 46) or
           api.engine.getComponent(ent, 27) or
           api.engine.getComponent(ent, 28) or
           api.engine.getComponent(ent, 49) or
           api.engine.getComponent(ent, 65) or
           api.engine.getComponent(ent, 60) then
